function out = sim_coulombPTOcompressiblePump(y0,par)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% sim_coulombPTOcompressiblePump.m function m-file
% AUTHORS:
...
%% Post-process analysis
    ...
    out.power.P_cvxP = out.q_wpAP.*(out.p_wpA - out.par.p_hin) ...
                     + out.q_wpBP.*(out.p_wpB - out.par.p_hin);
    out.power.P_cvTx = out.q_wpTA.*(out.par.p_lout - out.p_wpA) ...
                     + out.q_wpTB.*(out.par.p_lout - out.p_wpB);
...
%% %%%%%%%%%%%%   FUNCTIONS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function dydt = sys(t,y,par)
    	[dydt, ~ ] = sys_coulombPTOcompressiblePump(t,y,par);
    end

    function [dydt, nonState] = sysPost(t,y,par)
    	[dydt, nonState] = sys_coulombPTOcompressiblePump(t,y,par);
    end
