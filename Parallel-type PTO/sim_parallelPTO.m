function out = sim_parallelPTO(y0,par)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% sim_parallelPTO.m function m-file
% AUTHORS:
...
%
% UPDATES:
% 6/8/2023 - Created from sim_seriesPTO.m.
% 
...
stateIndex_parallelPTO % load state indices
...
%% Post-process analysis
    ...
    deltaE_sys = deltaE_LP + deltaE_HP ...
        + deltaE_lin + deltaE_lout + deltaE_hin + deltaE_hout ...
    ...
    P_loss = out.power.P_wpLoss + out.power.P_pmLoss + out.power.P_genLoss ...
            ...
            + out.power.P_hinPRV + out.power.P_houtPRV;
...
%% %%%%%%%%%%%%   FUNCTIONS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function [dydt, nonState, control] = sys_prototype(t,y,par)
        [dydt, nonState, control] = sys_parallelPTO(t,y,par);
    end
end
