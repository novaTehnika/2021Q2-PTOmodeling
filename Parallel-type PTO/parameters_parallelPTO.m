function par = parameters_parallelPTO(par,filenameCoeff,filenameRadSS)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% parameters_parallelPTO.m function m-file
% AUTHORS: 
...
%
% This function is for a model of a parallel-type PTO architecture.
%
% FILE DEPENDENCY:
% parameters_WECmodel.m
%
% UPDATES:
% 6/8/2023 - created from parameters_seriesPTO.m.
%
...
%     par.APP.C_f2 = -3.5e-4;
    ...
    par.pc_hin = 4e6; % [Pa] charge pressure
     % HPA at outlet from HP pipeline and inlet to RO module
    ...
    par.control.p_hout_nom = 6e6; % [Pa]
    par.control.p_RO_nom = par.control.p_hout_nom; % [Pa] (not actually used for as control input)
    par.control.p_lin_nom = 0.5e6; % [Pa] (not actually used for as control input)
    ...
    par.hinPRV.C = (maxPressure^(3/2) ...
     ...
     % high-pressure outlet of pipeline/inlet to house power pump/motor and
     % RO module
