% initialConditionDefault_parallelPTO.m script m-file
% AUTHORS:
...
%
% PURPOSE/DESCRIPTION:
% This script loads default intial conditions for the parallelPTO model.
%
% FILE DEPENDENCY:
%
% UPDATES:
...
y0(iyw_pm) = par.control.w_pm_ctrl.min;
