...
[q_inLP, q_outLP, dydt_pLineLP, pLsoln] = ...
        pipeline(t,y(iyLPPL),y(iyp_lin),y(iyp_lout),par,1,1);
nonState.pLinePPfricLP = pLsoln.PPfric;

 % high-pressure pipeline
[q_inHP, q_outHP, dydt_pLineHP, pLsoln] = ...
            pipeline(t,y(iyHPPL),y(iyp_hin),y(iyp_hout),par,2,1);
nonState.pLinePPfricHP = pLsoln.PPfric;

% State derivatives
dydt = zeros(11 + par.WEC.ny_rad,1);

dydt(iyp_lin) = 1/nonState.C_lin*(nonState.q_c - q_inLP - nonState.q_ERUfeed);
...
%% %%%%%%%%%%%%   FUNCTIONS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function [q_in, q_out, dydt_pLine, pLsoln] = ...
        ...
        [q_in, q_out, dydt_pLine, pLsoln] = ...
                 pipelineNPi_V01x01(t,y,p_in,p_out,par,lineID,postProcess);
    end
...
%                            + (delta_p_pm/beta)*(par.V_r + 1);
        ...
        mechLoss_pm = 0;%par.C_v*mu*abs(y(iyw_pm))/delta_p_pm - C_f;            
        ...
        nonState.q_ERUfeed = nonState.q_brine;
